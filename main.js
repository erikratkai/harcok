...
td1.innerHTML = array[1].td1_value; // Cella tartalmának beállítása
...
td2.innerHTML = array[1].td2_value; // Cella tartalmának beállítása
tr2.appendChild(td2); // Cella hozzáadása a sorhoz

const td3 = document.createElement("td"); // Harmadik cella létrehozása
td3.innerHTML = array[1].td3_value; // Cella tartalmának beállítása
...
td4.innerHTML = array[2].td4_value; // Cella tartalmának beállítása
tr3.appendChild(td4); // Cella hozzáadása a sorhoz

const td5 = document.createElement("td"); // Ötödik cella létrehozása
td5.innerHTML = array[2].td5_value; // Cella tartalmának beállítása
...
td6.innerHTML = array[3].td6_value; // Cella tartalmának beállítása
...
td7.innerHTML = array[3].td7_value; // Cella tartalmának beállítása
tr4.appendChild(td7); // Cella hozzáadása a sorhoz

const td8 = document.createElement("td"); // Nyolcadik cella létrehozása
td8.innerHTML = array[3].td8_value; // Cella tartalmának beállítása
...
td9.innerHTML = array[4].td9_value; // Cella tartalmának beállítása
tr5.appendChild(td9); // Cella hozzáadása a sorhoz

const td10 = document.createElement("td"); // Tizedik cella létrehozása
td10.innerHTML = array[4].td10_value; // Cella tartalmának beállítása
...
td11.innerHTML = array[5].td11_value; // Cella tartalmának beállítása
...
td12.innerHTML = array[5].td12_value; // Cella tartalmának beállítása
tr6.appendChild(td12); // Cella hozzáadása a sorhoz

const td13 = document.createElement("td"); // Tizenharmadik cella létrehozása
td13.innerHTML = array[5].td13_value; // Cella tartalmának beállítása
...
td14.innerHTML = array[6].td14_value; // Cella tartalmának beállítása
tr7.appendChild(td14); // Cella hozzáadása a sorhoz

const td15 = document.createElement("td"); // Tizenötödik cella létrehozása
td15.innerHTML = array[6].td15_value; // Cella tartalmának beállítása
